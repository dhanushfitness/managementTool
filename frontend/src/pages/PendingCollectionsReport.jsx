    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <div className="space-y-4">
          {/* Search Bar and Pending Summary */}
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              <div>
                <span className="text-gray-600">Service Non-PT Payments Pending: </span>
                <span className="text-orange-600 font-semibold">{formatCurrency(summary.serviceNonPTPending)}</span>
              </div>
              <div>
                <span className="text-gray-600">Service PT Payments Pending: </span>
                <span className="text-orange-600 font-semibold">{formatCurrency(summary.servicePTPending)}</span>
              </div>
              <div>
                <span className="text-gray-600">Product Payments Pending: </span>
                <span className="text-orange-600 font-semibold">{formatCurrency(summary.productPending)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
            >
              <option value="all">Service Payments Pending</option>
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">Payment Due Date</th>
